...
class Application : public FIX::Application, public FIX::MessageCracker {
  ...
  void sendMarketDataSnapshot(const FIX::MDReqID &, const FIX::Symbol &, const FIX::SessionID &);
  void addMarketDataEntry(FIX42::MarketDataSnapshotFullRefresh &, char, double, double);
