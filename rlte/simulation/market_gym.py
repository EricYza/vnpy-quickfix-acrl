...
class Market(gym.Env):
    ...
    def transition(self, action=None):
        ...
        execution_agent = self.agents[self.execution_agent_id]
        info = {'reward': execution_agent.cummulative_reward,
                'passive_fill_rate': execution_agent.limit_sells/execution_agent.initial_volume,
                'forced_liquidation_volume': execution_agent.forced_liquidation_volume,
                'forced_liquidation_rate': execution_agent.forced_liquidation_volume/execution_agent.initial_volume,
                'time': t,
                'drift': mid_price - initial_mid_price,
                'n_events': self.agents['noise_agent'].n_events,
                'terminated': terminated, 
                'volume': execution_agent.volume
                }
